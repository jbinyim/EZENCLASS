...
// const book2 = new Book("자바스크립트", 30000, "2025-02-05");
// console.log(book2);

// const today = new Date();
// const nowMomth = today.getMonth() + 1;
// const newDate = today.getDate();

// document.write("<h1>오늘 날짜 정보</h1>");
// document.write(`현재 월 : ${nowMomth}월 <br />`);
// document.write(`현재 일 : ${newDate}일 <br />`);
