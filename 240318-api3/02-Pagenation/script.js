...
const setPageOf = (pageNumber) => {
  ...
  // for 문은 특정 페이지에 보여줄 데이터의 범위를 계산하여 그 범위에 해당하는 데이터만큼 반복합니다. COUNT_PER_PAGE * (pageNumber - 1) + 1 식을 통해 현재 페이지의 첫 번째 데이터 인덱스를 계산하고, COUNT_PER_PAGE * (pageNumber - 1) + 6 식을 통해 마지막 데이터 인덱스를 계산합니다.
  for (
