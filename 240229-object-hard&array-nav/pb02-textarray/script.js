...
document.write(`${string}에는 ${letter}문자가 ${result}번 사용되었습니다`);

// const str1 = "Good moring, everyone. Beautiful moring";
// console.log(str1.indexOf("moring"));
// console.log(str1.indexOf("evening"));
// // console.log(str1.indexOf("evening", firstIndex + 1));
