// // 함수타입 & 제네릭타입
// // 함수는 어떤 값(의 타입)을 받아서 어떤 값을 반환

// const func = (a: number, b: number): number => {
//   return a + b;
// };

// // 1) 함수에 기본 매게변수를 설정할 때
// const inroduce = (name = "David") => {
...
// // 3) 함수에 전개연산자 형식의매개변수를 => rest 매개변수 설정할 떄
...
// // 8) 함수 : 타입호환성 > 매게변수 기준 (매개변수의 개수 다른 경우)
...
// // 10) 함수 구현 타입 정의 => 커스터마이징 => 사용자 정의 타입 가드
...
// const num06 = returnfirstValue([0, "1", "2"]);
